...
void register_plugin_nacl()
{
	...
	eth0.network_config(IP4::addr{ 10, 0, 0, 42 },
			    IP4::addr{ 255, 255, 255, 0 }, 0);
	auto &eth1 = Interfaces::get(0);
	eth1.network_config(IP4::addr{ 10, 0, 20, 42 },
			    IP4::addr{ 255, 255, 255, 0 }, 0);
	return;
	// Router
	INFO("NaCl", "Setup routing");
	Router<IP4>::Routing_table routing_table{
		{ IP4::addr{ 10, 0, 0, 0 }, IP4::addr{ 255, 255, 255, 0 }, 0,
		  eth0, 1 },
		{ IP4::addr{ 10, 0, 20, 0 }, IP4::addr{ 255, 255, 255, 0 }, 0,
		  eth1, 1 },
		{ IP4::addr{ 0 }, IP4::addr{ 0 }, IP4::addr{ 10, 0, 0, 1 },
		  eth0, 1 }
	};
