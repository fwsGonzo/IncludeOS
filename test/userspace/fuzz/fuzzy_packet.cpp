...
namespace fuzzy
{
uint8_t *add_eth_layer(uint8_t *data, FuzzyIterator &fuzzer,
		       net::Ethertype type)
{
...
uint8_t *add_ip4_layer(uint8_t *data, FuzzyIterator &fuzzer,
		       const net::ip4::Addr src_addr,
		       const net::ip4::Addr dst_addr, const uint8_t protocol)
{
...
uint8_t *add_udp4_layer(uint8_t *data, FuzzyIterator &fuzzer,
...
uint8_t *add_tcp4_layer(uint8_t *data, FuzzyIterator &fuzzer,
...
uint8_t *add_ip6_layer(uint8_t *data, FuzzyIterator &fuzzer,
		       const net::ip6::Addr src_addr,
		       const net::ip6::Addr dst_addr, const uint8_t protocol)
{
...
uint8_t *add_icmp6_layer(uint8_t *data, FuzzyIterator &fuzzer)
{
...
uint8_t *add_dns4_layer(uint8_t *data, FuzzyIterator &fuzzer, uint32_t xid)
{
