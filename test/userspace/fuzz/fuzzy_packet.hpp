...
extern uint8_t *add_ip6_layer(uint8_t *data, FuzzyIterator &fuzzer,
			      const net::ip6::Addr src_addr,
			      const net::ip6::Addr dst_addr,
			      const uint8_t protocol);
extern uint8_t *add_icmp6_layer(uint8_t *data, FuzzyIterator &fuzzer);

extern uint8_t *add_dns4_layer(uint8_t *data, FuzzyIterator &fuzzer,
			       uint32_t xid);
} // namespace fuzzy
