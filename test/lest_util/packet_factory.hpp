...
static net::Packet_ptr create_packet() noexcept
{
	...
	new (ptr) net::Packet(PHYS_OFFSET, 0, PHYS_OFFSET + PACKET_CAPA,
			      &bufstore);
...
static std::unique_ptr<net::PacketIP4>
create_ip4_packet_init(ip4::Addr src, ip4::Addr dst) noexcept
{
...
static std::unique_ptr<net::PacketIP6>
create_ip6_packet_init(ip6::Addr src, ip6::Addr dst) noexcept
{
...
static std::unique_ptr<net::tcp::Packet> create_tcp_packet() noexcept
{
	...
	ip4->set_ip_total_length(ip4->size());
	auto tcp =
		net::static_unique_ptr_cast<net::tcp::Packet>(std::move(ip4));
	return tcp;
}

static std::unique_ptr<net::tcp::Packet>
create_tcp_packet_init(Socket src, Socket dst) noexcept
{
...
static std::unique_ptr<net::PacketUDP>
create_udp_packet_init(Socket src, Socket dst) noexcept
{
	auto ip4 = create_ip4_packet();
