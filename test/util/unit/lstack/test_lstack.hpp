...
template <typename L> inline void print_summary(L &lstack)
{
#ifndef DEBUG_UNIT
	return;
#else
...
namespace test
{
template <typename Alloc, auto Sz> struct pool {
...
inline std::ostream &operator<<(std::ostream &out,
				const util::alloc::Allocation &a)
{
	out << std::hex << "[" << a.ptr << ","
	    << (uintptr_t)((char *)a.ptr + a.size) << " ] ("
