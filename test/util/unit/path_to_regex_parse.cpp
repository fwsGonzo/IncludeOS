...
CASE("String with two parameters, where one is a named parameter with asterisk (zero or more) "
     "(/:date/:test*)")
{
...
CASE("String with two parameters, where one is a named parameter with plus (one or more) "
     "(/:id/:test+")
{
...
CASE("String with two parameters, where one is a named parameter with plus (one or more) that only "
     "takes lower case letters, and one is a named parameter that only takes integers "
     "(/:test([a-z])+/:id(\\d+))")
{
...
CASE("String with two parameters, where one is a custom match parameter - only integers (one or "
     "more) (/:test/:id(\\d+))")
{
