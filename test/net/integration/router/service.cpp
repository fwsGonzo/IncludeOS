...
static bool route_checker(IP4::addr addr)
{
...
static void ip_forward(IP4::IP_packet_ptr pckt, Inet &stack,
		       Conntrack::Entry_ptr)
{
	...
	if (route == &stack) {
		INFO("ip_fwd",
		     "* Oh, this packet was for me, sow why was it forwarded here? \n");
		return;
	}
...
void Service::start(const std::string &)
{
	...
	// Routing table
	Router<IP4>::Routing_table routing_table{ { { 10, 42, 42, 0 },
						    { 255, 255, 255, 0 },
						    { 10, 42, 42, 2 },
						    inet2,
						    1 },
