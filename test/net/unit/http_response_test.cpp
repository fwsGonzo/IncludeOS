...
CASE("HTTP response can be created from a string")
{
	http::Response r(
		...
		"application/json\r\nContent-Length: "
		"194\r\n\r\n{\"version\":\"v0.9.3-1868-gd008d1a-dirty\",\"service\":\"Acorn Web "
		"Appliance\",\"heap_usage\":438272,\"cpu_freq\":2600.381981722683,\"boot_time\":\"2016-12-"
		"20T12:29:28Z\",\"current_time\":\"2017-01-10T16:03:53Z\"}");
