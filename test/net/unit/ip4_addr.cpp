...
CASE("Create IP4 addresses from strings")
{
	...
	std::vector<std::string> ips{ "0.0.0.0",	 "255.255.255.255",
				      "1.2.3.4",	 "11.22.33.44",
				      "111.222.255.255", "195.22.13.24",
				      "195.255.13.24",	 "196.209.13.24",
				      "197.111.13.24",	 "198.211.13.24",
				      "199.210.13.24",	 "200.220.13.24",
				      "201.230.13.24",	 "202.240.13.24",
				      "203.250.13.24",	 "204.251.13.24" };
