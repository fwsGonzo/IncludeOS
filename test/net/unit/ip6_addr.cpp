...
CASE("Create IP6 addresses from strings")
{
	...
	Addr addr3{};
	// lowercase test
	std::string valid_addr_string1{
		"fe80:0000:0000:0000:e823:fcff:fef4:85bd"
	};
	std::string valid_addr_short_string1{ "fe80::e823:fcff:fef4:85bd" };
	// uppercase test
	std::string valid_addr_string2{
		"FE80:0000:0000:0000:E823:FCFF:FEF4:84AA"
	};
	...
	// edge cases
	EXPECT(Addr{ "FFFF:FFFF:FFFF:FFFF:FFFF:FFFF:FFFF:FFFF" } ==
	       Addr(0xffff, 0xffff, 0xffff, 0xffff, 0xffff, 0xffff, 0xffff,
		    0xffff));
	EXPECT(Addr{ "0000:0000:0000:0000:0000:0000:0000:0000" } ==
	...
	EXPECT_THROWS(Addr{ "1:2:3:4:5:6:7::" } ==
		      Addr(1, 2, 3, 4, 5, 6, 7, 0));
	EXPECT_THROWS(Addr{ "::2:3:4:5:6:7:8" } ==
		      Addr(0, 2, 3, 4, 5, 6, 7, 8));
...
CASE("IP6 addresses can be compared to each other")
{
	...
	uint8_t netmask = 64;
	const Addr not_terrorist{ 0xfe80, 0,	  0,	  0,
				  0xe823, 0xfcff, 0xfef4, 0x85bd };
