...
{
	EXPECT_THROWS((Cookie{
		"name", "value", { "", "Sun, 06 Nov 1994 08:49:37 GMT" } }));
}

CASE("CookieException thrown when creating Cookie with invalid option name")
{
	EXPECT_THROWS(
		(Cookie{ "name", "value", { "something", "something" } }));
	EXPECT_THROWS(
		(Cookie{ "name",
			 "value",
			 { "expires_", "Sun, 06 Nov 1994 08:49:37 GMT" } }));
}
...
CASE("CookieException thrown when creating Cookie with odd number of vector-elements")
{
	...
	EXPECT_THROWS((Cookie{ "name",
			       "value",
			       { "Expires", "Sun, 06 Nov 1994 08:49:37 GMT",
				 "Path", "/something123", "Domain" } }));
}
...
CASE("No CookieException thrown when creating Cookie with multiple valid options")
{
	...
	EXPECT_NO_THROW(
		(Cookie{ "name",
			 "value",
			 { "Expires", "Sun, 06 Nov 1994 08:49:37 GMT", "Path",
			   "/some_path_here", "domain", "example.com" } }));
	EXPECT_NO_THROW(
		(Cookie{ "name",
			 "value",
			 { "Expires", "Sun, 06 Nov 1994 08:49:37 GMT", "Path",
			   "/some_path_here", "domain", "example.com", "secure",
			   "true", "httponly", "true" } }));
	EXPECT_NO_THROW((Cookie{ "name",
				 "value",
				 { "Expires", "Sun, 06 Nov 1994 08:49:37 GMT",
				   "Path", "/anotherPath134", "secure", "true",
				   "domain", "example.com" } }));
}
...
CASE("Creating cookies with valid values and changing these values")
{
	...
	*/
	...
	Or just: */
		vector<string> v{ "Expires",  "Sun, 06 Nov 2004 08:49:37 GMT",
				  "Path",     "/anotherPath134",
				  "secure",   "true",
				  "httponly", "true",
				  "Domain",   "example.com",
		...
		WHEN("Creating cookie")
		{
			...
			AND_THEN(
				"Get a string containing existing values when calling the cookie's to_string "
				"method")
			{
				EXPECT(c.to_string() ==
				       "name=value; Expires=Sun, 06 Nov 2004 08:49:37 GMT; Max-Age=600; "
				       "Domain=example.com; Path=/anotherPath134; Secure; HttpOnly");
			}
		}
	}
	...
	GIVEN("A Cookie object containing name, value and two valid options")
	{
		...
		WHEN("Getting the cookie's to_string")
		{
			...
			{
				EXPECT(c.to_string() ==
				       "name=value; Max-Age=402000; Path=/some path");
			}
		}
	}
}
...
CASE("No CookieException thrown when creating Cookie with valid Expires option")
{
	...
	EXPECT_NO_THROW(
		(Cookie{ "name",
			 "value",
			 { "expires", "Mon, 12 Jan 1995 23:59:00 GMT" } }));
	EXPECT_NO_THROW(
		(Cookie{ "name",
			 "value",
			 { "Expires", "tue, 30 May 1999 21:09:55 GMT" } }));
	EXPECT_NO_THROW(
		(Cookie{ "name",
			 "value",
			 { "Expires", "Wed, 31 Dec 2018 16:09:59 GMT" } }));
	EXPECT_NO_THROW(
		(Cookie{ "name",
			 "value",
			 { "expires", "Thu, 22 Feb 2013 19:17:11 GMT" } }));
	EXPECT_NO_THROW(
		(Cookie{ "name",
			 "value",
			 { "Expires", "fri, 01 Mar 2023 13:00:06 GMT" } }));
	EXPECT_NO_THROW(
		(Cookie{ "name",
			 "value",
			 { "expiREs", "saT, 9 Apr 2016 00:09:44 GMT" } }));
	...
	EXPECT_NO_THROW(
		(Cookie{ "name",
			 "value",
			 { "expires", "Monday, 12-Jan-95 23:59:00 GMT" } }));
	EXPECT_NO_THROW(
		(Cookie{ "name",
			 "value",
			 { "Expires", "tuesday, 30-May-99 21:09:55 GMT" } }));
	EXPECT_NO_THROW(
		(Cookie{ "name",
			 "value",
			 { "Expires", "Wednesday, 31-Dec-18 16:09:59 GMT" } }));
	EXPECT_NO_THROW(
		(Cookie{ "name",
			 "value",
			 { "expires", "Thursday, 22-Feb-13 19:17:11 GMT" } }));
	EXPECT_NO_THROW(
		(Cookie{ "name",
			 "value",
			 { "Expires", "friday, 01-Mar-23 13:00:06 GMT" } }));
	EXPECT_NO_THROW(
		(Cookie{ "name",
			 "value",
			 { "expIres", "saTurday, 09-Apr-16 00:09:44 GMT" } }));

	// Format: Sun Nov 6 08:49:37 1994 / %a %b %d %H:%M:%S %Y

	EXPECT_NO_THROW((Cookie{
		"name", "value", { "Expires", "Sun Nov 6 08:49:37 1994" } }));
	EXPECT_NO_THROW((Cookie{
		"name", "value", { "expires", "Mon Jan 12 23:59:00 1995" } }));
	EXPECT_NO_THROW((Cookie{
		"name", "value", { "Expires", "tue May 30 21:09:55 1999" } }));
	EXPECT_NO_THROW((Cookie{
		"name", "value", { "Expires", "Wed Dec 31 16:09:59 2018" } }));
	EXPECT_NO_THROW((Cookie{
		"name", "value", { "expires", "Thu Feb 22 19:17:11 2013" } }));
	EXPECT_NO_THROW((Cookie{
		"name", "value", { "Expires", "fri Mar 1 13:00:06 2023" } }));
	EXPECT_NO_THROW((Cookie{
		"name", "value", { "expiRes", "saT Apr 9 00:09:44 2016" } }));
}
...
CASE("CookieException thrown when creating Cookie with invalid Expires option")
{
	...
	EXPECT_THROWS(
		(Cookie{ "name",
			 "value",
			 { "Expires", "Sunday 06 Nov 1994 08:49:37 GMT" } }));
	EXPECT_THROWS(
		(Cookie{ "name",
			 "value",
			 { "Expires", "Man, 12 Jan 1995 23:59:00 GMT" } }));
	EXPECT_THROWS(
		(Cookie{ "name",
			 "value",
			 { "Expires", "tue, 30-May 1999 21:09:55 GMT" } }));
	EXPECT_THROWS(
		(Cookie{ "name",
			 "value",
			 { "Expires", "Wed, 31 Des 2018 16:09:59 GMT" } }));
	EXPECT_THROWS(
		(Cookie{ "name",
			 "value",
			 { "Expires", "Thu, 22 Feb 2013 24:17:11 GMT" } }));
	EXPECT_THROWS(
		(Cookie{ "name",
			 "value",
			 { "Expires", "fri, 01 Mar 2023 25:00:06 GMT" } }));
	EXPECT_THROWS(
		(Cookie{ "name",
			 "value",
			 { "Expires", "saT 09 Apr 2016 00:09:44 GMT" } }));
	EXPECT_THROWS((Cookie{ "name",
			       "value",
			       { "Expires", "saT, 09 Jun-99 00:09:44 GMT" } }));
	EXPECT_THROWS((Cookie{ "name", "value", { "Expires", "abc" } }));
	EXPECT_THROWS((Cookie{
		"name", "value", { "Expires", "saT, Apr 16 00:09:44 GMT" } }));
#ifndef __APPLE__
	// this one broken on macaroni
	EXPECT_THROWS((Cookie{
		"name", "value", { "Expires", "Sun Nov 6 08:49:37" } }));
#endif
	EXPECT_THROWS((Cookie{ "name", "value", { "Expires", "" } }));
}
...
CASE("No CookieException thrown when creating Cookie with valid Domain option")
{
	...
	EXPECT_NO_THROW((Cookie{
		"name", "value", { "DOMAIN", "service.example.com" } }));
	EXPECT_NO_THROW((Cookie{
		"name",
		"value",
		{ "Domain",
		  "whateverdomainyouwant123.thebrowserremovesitifnotyourdomain" } }));
	EXPECT_NO_THROW((Cookie{ "name", "value", { "Domain", "" } }));
}

/* All characters are allowed in the domain option, but the browser will ignore it if the domain you
enter isn't yours CASE("CookieException thrown when creating Cookie with invalid Domain option") {},
*/
...
CASE("No CookieException thrown when creating Cookie with valid Path option")
{
	...
	EXPECT_NO_THROW(
		(Cookie{ "name",
			 "value",
			 { "PATH", "/ex?mypath even with whitespaces" } }));
	EXPECT_NO_THROW(
		(Cookie{ "name",
			 "value",
			 { "Path", "/whatever/path/you/want/:&something" } }));
