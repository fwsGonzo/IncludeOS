...
__attribute__((weak)) void softreset_service_handler(const void *, size_t)
{
}
...
extern "C" void *__os_store_soft_reset(void *extra, size_t extra_len)
{
	uintptr_t memory_end = kernel::state().liveupdate_phys +
			       kernel::state().liveupdate_size;
