...
extern uintptr_t _multiboot_free_begin(uintptr_t bootinfo);
extern uintptr_t _multiboot_memory_end(uintptr_t bootinfo);
...
// x86 kernel start
extern "C" __attribute__((no_sanitize("all")))
