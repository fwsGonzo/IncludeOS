...
extern "C" int syscall_SYS_rt_sigprocmask(int how, const sigset_t *set,
					  sigset_t *oldset)
{
	if
		constexpr(__strace)
		{
			...
			stubtrace_print("sys_rt_sigprocmask", howstr, set,
					oldset);
			return ret;
		}
...
extern "C" long syscall_SYS_sigmask(int signum)
{
