...
long socketcall_getsockopt(int sockfd, int level, int optname, void *optval,
			   socklen_t *optlen)
{
	return -ENOSYS;
}
long socketcall_setsockopt(int sockfd, int level, int optname,
			   const void *optval, socklen_t optlen)
{
	return -ENOSYS;
}
long socketcall_getsockname(int sockfd, struct sockaddr *addr,
			    socklen_t *addrlen)

{
	return -ENOSYS;
}
long socketcall_getpeername(int sockfd, struct sockaddr *addr,
			    socklen_t *addrlen)
...
long socketcall_bind(int sockfd, const struct sockaddr *addr, socklen_t addrlen)
{
...
ssize_t socketcall_sendto(int sockfd, const void *buf, size_t len, int flags,
			  const struct sockaddr *dest_addr, socklen_t addrlen)
{
	return strace(sock_sendto, "sendto", sockfd, buf, len, flags, dest_addr,
		      addrlen);
}
...
ssize_t socketcall_recvfrom(int sockfd, void *buf, size_t len, int flags,
			    struct sockaddr *src_addr, socklen_t *addrlen)
{
	return strace(sock_recvfrom, "recvfrom", sockfd, buf, len, flags,
		      src_addr, addrlen);
}
