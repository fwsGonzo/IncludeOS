...
#ifdef ARCH_i686
extern "C" void FASTCALL
__context_switch(uintptr_t stack, Context::context_func &func) GCCFASTCALL;
#else
extern "C" void __context_switch(uintptr_t stack, Context::context_func &func);
#endif
extern "C" void *get_cpu_esp();

extern "C" void __context_switch_delegate(uintptr_t,
					  Context::context_func &func)
{
	func();
}
...
void Context::create(unsigned stack_size, context_func func)
{
	...
	auto stack_mem = std::unique_ptr<char[]>(new char[16 + stack_size],
