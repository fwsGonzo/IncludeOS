...
Write_queue::Write_queue(WriteCallback cb)
	: current_(0), offset_(0), acked_(0), on_write_(cb)
{
}
...
__attribute__((weak)) int Write_queue::deserialize_from(void *)
{
	return 0;
}
__attribute__((weak)) int Write_queue::serialize_to(void *) const
{
	return 0;
}
