...
template <typename Ptr_type> class Packet6_v : public Packet_v<Ptr_type> {
    public:
	Packet6_v(Ptr_type ptr) : Packet_v<Ptr_type>(std::move(ptr))
	{
...
template <typename Ptr_type> inline void Packet6_v<Ptr_type>::init()
{
	// clear TCP header
