...
template <typename View4> uint16_t calculate_checksum4(const View4 &packet)
{
...
template <typename View6> uint16_t calculate_checksum6(const View6 &packet)
{
	constexpr uint8_t Proto_UDP = 17;
