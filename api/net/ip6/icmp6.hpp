...
class ICMPv6 {
	...
	void destination_unreachable(Packet_ptr pckt,
				     icmp6::code::Dest_unreachable code);
	...
	void ping(ip6::Addr ip, icmp_func callback,
	...
	{
		return (pckt_size >=
			sizeof(ip6::Header) + icmp6::Packet::header_size());
	}
	...
	void send_response(
		icmp6::Packet &req, ICMP_type type, ICMP_code code,
