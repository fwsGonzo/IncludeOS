...
inline util::sview Request::post_value(util::csview name) const noexcept
{
	...
	//---------------------------------
	if (lock_and_load == util::sview::npos)
		return {};
	//---------------------------------
...
///////////////////////////////////////////////////////////////////////////////
template <typename = void> inline Request_ptr make_request()
{
	return std::make_unique<Request>();
}

///////////////////////////////////////////////////////////////////////////////
template <typename = void> inline Request_ptr make_request(std::string request)
{
