...
{
	return (status_code >= Multiple_Choices) and
...
{
	return (status_code >= Bad_Request) and
...
{
	return (status_code >= Internal_Server_Error) and
	       (status_code <= Network_Authentication_Required);
}
