...
class S2N_server : public http::Server {
	...
	inline S2N_server(const std::string &ca_cert, const std::string &ca_key,
...
inline S2N_server::S2N_server(const std::string &ca_key,
			      const std::string &ca_cert, net::TCP &tcp,
			      Args &&... server_args)
