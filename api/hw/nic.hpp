...
class Nic : public Device {
	...
	static constexpr uint32_t buffer_limit_default =
		NIC_BUFFER_LIMIT_DEFAULT;
	...
	uint32_t buffer_limit() const noexcept
	{
	...
	uint32_t sendq_limit() const noexcept
	{
		return m_sendq_limit;
	}
