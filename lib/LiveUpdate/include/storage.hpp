...
struct storage_header {
	...
	void add_string_vector(uint16_t id,
	...
	inline storage_entry &var_entry(int16_t type, uint16_t id,
					construct_func func);
...
template <typename... Args>
inline storage_entry &storage_header::create_entry(Args &&... args)
{
	// create entry
...
inline storage_entry &storage_header::var_entry(int16_t type, uint16_t id,
						construct_func func)
{
	// create entry
	auto *entry = (storage_entry *)&vla[length];
